...
class EskulModel extends CI_Model
{
    public function select_all_eskul()
    {
        //memang semua kolom
        $this->db->select('*');
        //didalam table siswa
    ...
    public function select_eskul_by($where)
    {
          //memang semua kolom
          $this->db->select('*');
